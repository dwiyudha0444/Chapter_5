...
import com.dwiyu.chapter_5_androidpermission.databinding.ActivityCamGalPermissionBinding
import java.io.File

@Suppress("DEPRECATION")
class CamGalPermission : AppCompatActivity() {
    lateinit var binding: ActivityCamGalPermissionBinding
    @SuppressLint("ObsoleteSdkInt", "QueryPermissionsNeeded")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCamGalPermissionBinding.inflate(layoutInflater)
